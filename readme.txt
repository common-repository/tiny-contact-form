...
* nl: Erik Collou http://www.webmaak.nl 
* sv: Thomas http://www.ajfix.se
* tr: Emrullah Tahir Ekmek&ccedil;i http://emrullahekmekci.com.tr

== Changelog ==

+ new language: Turkish, thanks to Emrullah Tahir Ekmek&ccedil;i
+ new language: Dutch, thanks to Erik Collou
+ new language: Arabic, thanks to qasem http://gaayat.com
+ language update: Italian, thanks to Alberto Scocco http://www.lemappedelpensiero.it
